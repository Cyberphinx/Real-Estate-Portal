...
export const propertyTypeOptions = [
    ...
    {text: 'Block of flats', value: PropertyType.blockOfApartments},
    ...
    {text: 'Chateau', value: PropertyType.castle},
    {text: 'Cottage', value: PropertyType.cottage},
    {text: 'Country house', value: PropertyType.countryHouse},
    {text: 'Detached house', value: PropertyType.detachedHouse},
    {text: 'Detached bungalow', value: PropertyType.detachedBungalow},
    {text: 'End terrace', value: PropertyType.endOfTerraceHouse},
    {text: 'Equestrian', value: PropertyType.equestrianFacility},
    {text: 'Farm', value: PropertyType.farm},
    {text: 'Farm house', value: PropertyType.farmHouse},
    {text: 'Finca', value: PropertyType.finca},
    {text: 'Flat', value: PropertyType.flat},
    {text: 'Hotel', value: PropertyType.hotelRoom},
    {text: 'Houseboat', value: PropertyType.houseBoat},
    {text: 'Industrial', value: PropertyType.industrialDevelopment},
    {text: 'Land', value: PropertyType.land},
    {text: 'Leisure', value: PropertyType.leisureFacility},
    {text: 'Light industrial', value: PropertyType.lightIndustrial},
    {text: 'Link-detached house', value: PropertyType.linkDetachedHouse},
    ...
    {text: 'Pub bar', value: PropertyType.pub},
    {text: 'Restaurant', value: PropertyType.restaurant},
    {text: 'Retail', value: PropertyType.retailPropertyHighStreet},
    {text: 'Riad', value: PropertyType.riad},
    {text: 'Semi-detached house', value: PropertyType.semiDetachedHouse},
    {text: 'Semi-detached bungalow', value: PropertyType.semiDetachedBungalow},
    {text: 'Studio', value: PropertyType.studio},
    {text: 'Terraced house', value: PropertyType.terracedHouse},
