        ...
        >
            <div className={selectedListing?.id === listing!.id ? "card-selected" : "card"} >
                ...
                <section className="gallery">
                    <div style={{ position: "relative" }}>
                        {listingImages!.length > 0
                            ? <img
                                src={selectedListingForImage?.id === listing!.id ? image!.url : mainImage!.url}
                        ...
                        listingBigImages!.indexOf(image!) < 0 ? listingBigImages!.indexOf(mainImage!) + 1 : listingBigImages!.indexOf(image!) + 1
                ...
                <section className="card-description">
                    <h1 style={{ fontSize: "1rem", fontWeight:'normal' }}>{listing?.listingLocation.displayAddress}</h1>
                </section>
            </div>
        </div>
    );
