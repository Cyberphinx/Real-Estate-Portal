                    ...
                    {({ handleSubmit, isSubmitting, errors, isValid, dirty }) => {
                        return (
                            <Form onSubmit={handleSubmit} autoComplete="off">
                                ...
                                <select className='account-selection'>
                                    <option>Individual account</option>
                                    <option>Property agent account</option>
                                    {/* <option>Tradesperson account</option> */}
                                </select>
                                ...
                                <p className='register-suggestion'>Already on Sanctum? <button className='register-suggestion-button'
                                onClick={() => {
                                    {
                                        closeModal();
                                        openModal(<LoginForm />);
