...
namespace Application.Extensions
{
    public static class ListingExtensions
    {
        ...
        public static IQueryable<Listing> Search(this IQueryable<Listing> query, string searchTerm)
        {
        ...
        public static IQueryable<Listing> Filter(this IQueryable<Listing> query, string channel,
        ...
        public static IQueryable<Listing> SearchMap(this IQueryable<Listing> query, string mapBounds)
        {
            ...
            p.ListingLocation.Coordinates.Latitude > MinLatitude && p.ListingLocation.Coordinates.Longitude > MinLongitude 
            && p.ListingLocation.Coordinates.Latitude < MaxLatitude && p.ListingLocation.Coordinates.Longitude < MaxLongitude);
        }
    }
}