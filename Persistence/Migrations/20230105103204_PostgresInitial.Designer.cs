...
namespace Persistence.Migrations
{
    ...
    [Migration("20230105103204_PostgresInitial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.AppUserAggregate.Objects.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.AppUserAggregate.Objects.InvoiceItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "1",
                            ConcurrencyStamp = "3fb92e13-507e-4e13-bf86-c9f665f847c0",
                            Name = "Company",
                        ...
                        {
                            Id = "2",
                            ConcurrencyStamp = "0f37cf62-a211-4f14-b5ab-5926ef67ec64",
                            Name = "Customer",
                        ...
                        {
                            Id = "3",
                            ConcurrencyStamp = "3610c2ff-0d11-4ab0-839b-c5ba587438cf",
                            Name = "Agency",
                        ...
                        {
                            Id = "4",
                            ConcurrencyStamp = "894e3134-1135-45db-bb8b-19eaaabe59dd",
                            Name = "Admin",
            ...
            modelBuilder.Entity("Domain.AppUserAggregate.Objects.InvoiceItem", b =>
                {
                    b.HasOne("Domain.AppUserAggregate.Objects.Invoice", "Invoice")
                        .WithMany("Items")
